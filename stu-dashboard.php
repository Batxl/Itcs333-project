...
try {
    ...
    $sql = "SELECT booking_id, room_id, booking_date, start_time, end_time 
            FROM bookings 
            WHERE user_id = :user_id AND booking_date >= CURDATE() 
            ...
            <div class='menu-items'>
                <ul class='navLinks'>
                    <li class='navList active'>
                        <a href='index.php'>
                            <i class='fa-solid fa-house fa-lg' style='margin: 5px;'></i>
                            <span class='links'>Index</span>
                        </a>
                    </li>
                    <li class='navList'>
                        <a href='book_form.php'>
                            <i class='fa-solid fa-plus fa-lg' style='margin: 15px;'></i>
                            <span class='links'>Booking</span>
                        </a>
                    </li>
                    <li class='navList'>
                        <a href='bookingtable.php'>
                            <i class='fa-solid fa-table fa-lg' style='margin: 10px;'></i>
                            <span class='links'>Booked</span>
                        </a>
                    </li>
                    <li class='navList'>
                        <a href='comments.php'>
                            <i class='fa-solid fa-comment fa-lg' style='margin: 10px;'></i>
                ...
                <ul class='bottom-link'>
                    <li>
                        <a href='logout.php'>
                            <i class='fa-solid fa-arrow-right-from-bracket fa-lg' style='margin: 10px;'></i>
